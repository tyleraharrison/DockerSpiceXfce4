...
RUN     DEBIAN_FRONTEND=noninteractive  apt-get update && apt-get -y --no-install-recommends install tango-icon-theme xfce4-notifyd xfce4-terminal xubuntu-icon-theme dbus-x11 firefox gnome-terminal sudo
